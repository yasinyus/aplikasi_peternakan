                                        ...
                                        <form class="user" method="post" action="<?= base_url('admin/flock/update'); ?>">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="">Nama Flock</label>
												 <div class="col-sm-9">
                                                    <input type="text" name="nama_flock" class="form-control" id="" placeholder="Masukkan Nama Flock" value="<?= $flock->nama_flock ?>">
                                            ...
                                            <!-- <div class="form-group row">
												...
												<div class="col-sm-9">
													<select name="peternakan_id" id="" class="form-control disabled">
                                                        <option>Pilih</option>
                                                        <?php foreach($peternakan as $p){ ?>
                                                            <option value="<?= $p->id_peternakan ?>" <?php if($p->id_peternakan == $flock->peternakan_id ){echo 'selected';} ?>><?= $p->nama_peternakan ?> -- <?= $p->tipe_peternakan  ?> | <?= $p->lokasi_peternakan ?></option>
                                                        <?php } ?>
													</select>
												</div>
                                            </div> -->
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
                                                    ...
                                                    <div class="input-group number">
                                                        ...
                                                        <input class="form-control" type="text" name="jumlah_ayam[]" value="<?=  $k->jumlah_ayam ?>" placeholder="Jumlah Ayam"/><br>
                                            ...
                                            <a href="<?= base_url('admin/flock') ?>" class="btn btn-success"><i class="fa fa-chevron-left"></i> Kembali ke List Flock</a>
                                          </form>
                                    </div>
                                </div>
                            </div>
