<div class="main-content">
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Edit User</h5>
                                            <span>Edit detail user dibawah ini</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                ...
                <div class="auth-credentials">
                    ...
                    <input type="text" name="nama" onkeydown="return /[a-z, ]/i.test(event.key)" class="form-control"  placeholder="Nama lengkap" value="<?= $user->nama ?>">
                    <!-- <label for="signInEmail" class="form-label mt-4">Nama Peternakan</label>
                    <input type="text" name="nama_peternakan" class="form-control"  placeholder="Nama Peternakan"> -->
                    ...
                    <input type="number" name="no_telp" onkeydown="javascript: return event.keyCode == 69 ? false : true" minlength="8" maxlength="20" class="form-control"  placeholder="No HP" value="<?= $user->no_telp ?>">
                   
                    <label for="signInEmail" class="form-label mt-4">Tipe User</label>
                    <select name="tipe_user" id="" class="form-control">
                        <option value="">Select User Type</option>
                        <option value="admin_input" <?php if($user->tipe_user == "admin_input") {echo "selected";} ?>>Admin Input</option>
                        <option value="super_user" <?php if($user->tipe_user == "super_user") {echo "selected";} ?>>Super User</option>
                    </select>
                    ...
                    <select name="id_peternakan" id="" class="form-control" required>
                        ...
                        <?php foreach($peternakan as $data){ ?>
                            <option value="<?= $data->id_peternakan ?>" <?php if($data->id_peternakan == $user->id_peternakan) {echo "selected";} ?>><?= $data->nama_peternakan ?></option>
                        <?php } ?>
                    </select>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
                        ...
                        <a href="<?= base_url('admin/users/list_downline') ?>" class="btn btn-light">Batal</a>
					</div>
                </div>
