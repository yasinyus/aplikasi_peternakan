                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Detail Produksi Layer</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <form class="user" method="post" action="<?= base_url('admin/produksi/update_layer_post'); ?>">
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-sm-9">
													<select name="peternakan_id" id="peternakan" class="form-control">
											...
											<div class="form-group row mt-3">
                                                <label class="col-sm-3 col-form-label" for="">Tanggal *</label>
												 <div class="col-sm-9">
                                                    ...
                                                    <input type="date" name="tanggal_prod" class="form-control" value="<?= $produksi_layer->tanggal_prod ?>" id="" placeholder="" required>
												</div>
                                            </div>
                                            <div class="form-group row mt-3">
                                            ...
                                            <a href="<?= base_url('admin/produksi/layer') ?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
                                          </form>
                                    </div>
                                </div>
                            </div>
