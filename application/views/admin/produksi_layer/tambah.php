                                    ...
                                    <div class="card-body">
                                        <form class="user" method="post" action="<?= base_url('admin/produksi/insert_layer'); ?>">
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<select name="flock_id" id="flock" class="form-control" required>
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<select name="kandang_id" id="kandang" class="form-control" required>
                                            ...
                                            <div class="form-group row mt-3">
                                                <label class="col-sm-3 col-form-label" for="">Tanggal *</label>
                                                 ...
                                                 <?php
                                                    ...
                                                    $today = date("Y-m-d");
                                                ?>
                                                    <input type="date" name="tanggal_prod" class="form-control" id="" placeholder="" value="<?php echo $today; ?>" max="<?php echo date("Y-m-d"); ?>" required>
                                            ...
                                            <div class="form-group row mt-3">
                                                <label class="col-sm-3 col-form-label" for="">Jumlah Utuh *</label>
												 <div class="input-group col-sm-4">
                                                    <input type="number" step="0.1" name="jml_utuh_butir" class="form-control" id="" placeholder="100" required>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">butir</span>
													</div>
                                                </div>
												 <div class="input-group col-sm-5">
                                                    <input type="number" step="0.1" name="jml_utuh_kg" class="form-control" id="" placeholder="5.50" required>
													<div class="input-group-append">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="">Sortir (Putih, lainnya) *</label>
												 <div class="input-group col-sm-4">
                                                    <input type="number" step="0.1" name="sortir_butir" class="form-control" id="" placeholder="5" required>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">butir</span>
													</div>
                                                </div>
												 <div class="input-group col-sm-5">
                                                    <input type="number" step="0.1" name="sortir_kg" class="form-control" id="" placeholder="0.20" >
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">kg</span>
													</div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="">BS *</label>
												 <div class="input-group col-sm-4">
                                                    <input type="number" step="0.1" name="bs_butir" class="form-control" id="" placeholder="5" required>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">butir</span>
													</div>
                                                </div>
												 <div class="input-group col-sm-5">
                                                    <input type="number" step="0.1" name="bs_kg" class="form-control" id="" placeholder="0.20" required>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">kg</span>
													</div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="">Cangkang *</label>
												 <div class="input-group col-sm-4">
                                                    <input type="number" step="0.1" name="cangkang_butir" class="form-control" id="" placeholder="5" required>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">butir</span>
													</div>
                                                </div>
												 <div class="input-group col-sm-5">
                                                    <input type="number" step="0.1" name="cangkang_kg" class="form-control" id="" placeholder="0.20" required>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">kg</span>
													</div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="">Bobot Ayam</label>
												 <div class="input-group col-sm-9">
                                                    <input type="number" step="0.001" name="bobot_ayam" class="form-control" id="" placeholder="2.500">
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">kg</span>
													</div>
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-sm-9">
                                                    <input type="number"  name="kematian" class="form-control" id="" placeholder="2" required value="0"> 
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="" class="col-sm-3 col-form-label">Afkir</label>
												<div class="col-sm-9">
                                                    <input type="number"  name="afkir" class="form-control" id="" placeholder="0" required value="0">
                                                </div>
                                            </div>
                                            <div class="form-group row">
