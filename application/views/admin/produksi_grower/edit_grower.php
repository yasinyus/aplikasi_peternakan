                                        ...
                                        <form class="user" method="post" action="<?= base_url('admin/produksi/update_grower_post'); ?>">
											...
											<div class="form-group row mt-3">
                                                <label class="col-sm-3 col-form-label" for="">Tanggal *</label>
												 <div class="col-sm-9">
                                                    ...
                                                    <input type="date" name="tanggal_prod" class="form-control" value="<?= $produksi_grower->tanggal_prod ?>" id="" placeholder="" readonly>
												</div>
                                            </div>
                                            <div class="form-group row mt-3">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="">bobot_ayam</label>
												 <div class="input-group col-sm-9">
                                                    <input type="number" step="0.001" name="bobot_ayam" class="form-control" id="" value="<?= $produksi_grower->bobot_ayam ?>">
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
                                            		...
                                            		<a href="<?= base_url('admin/produksi/grower') ?>" class="btn btn-light"><i class="fa fa-arrow-left"></i> Kembali</a>
